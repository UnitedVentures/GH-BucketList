...
export const itineraries = {
  ...
  'christmas-markets': {
    ...
    facts: [
      ...
      { label: 'Route', value: 'Dresden (2 nights) · Prague (4 nights) · Bratislava (1 night) · Vienna (3 nights)' },
    ...
    days: [
      ...
      },
      {
        ...
        text: 'A free day to explore Prague at your own pace. Recommended stops include Prague Castle, St Vitus Cathedral, St George’s Basilica and Golden Lane; the charming streets of Malá Strana; a peaceful walk on Kampa Island along the Vltava; panoramic views from Petřín Hill; and the shopping streets around Wenceslas Square and Na Příkopě. In the evening, return to Prague’s Christmas markets for the festive atmosphere, seasonal treats and holiday decorations. Overnight in Prague.',
      },
      {
        day: 'Day 07',
      ...
      },
      {
        ...
        text: 'A guided walking tour of Vienna’s highlights — the Minoritenkirche, Heldenplatz, the Hofburg, the Spanish Riding School, the Albertina, the State Opera and Stephansdom — followed by an evening at the Vienna Christmas World at Rathausplatz and the Maria-Theresien-Platz Christmas Village. Overnight in Vienna.',
      },
      {
        day: 'Day 10',
        title: 'Schönbrunn Palace & Christmas Market',
        text: 'A guided tour of Schönbrunn Palace and its gardens with skip-the-line access, followed by the Schönbrunn Christmas Market in the palace courtyard — decorated stalls, traditional Austrian handicrafts, seasonal treats and mulled wine beneath the palace facade. With time to spare, optional visits to Rathausplatz’s Vienna Christmas World, the Maria-Theresien-Platz Christmas Village or the more intimate, artisan Spittelberg Christmas Market. Round off the evening with Vienna’s festive atmosphere, local cafés and traditional Austrian treats. Overnight in Vienna.',
      },
      {
        day: 'Day 11',
        title: 'Departure',
    ...
    inclusions: [
      ...
      'First-class train tickets between all four cities',
    ...
    rates: {
      note: 'Per person, in LKR, on twin/double sharing basis. Excludes visa, international & domestic flight tickets, meals not mentioned in the itinerary, driver and guide tips, and anything else not mentioned in the itinerary.',
      rows: [
        { tier: 'Twin Sharing', twin: 'LKR 980,000', single: 'On Request' },
      ],
    },
  },
  'machu-picchu': {
